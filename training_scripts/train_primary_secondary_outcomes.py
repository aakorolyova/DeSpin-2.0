...
if __name__ == '__main__':
    directory = r'..\data\Primary_Secondary_Outcomes'
    filenames = ['po_sent_marked_col_p1_coord.txt', 'po_sent_marked_col_p2_coord.txt',
                 'so_sent_marked_col_p1_coord.txt', 'so_sent_marked_col_p2_coord.txt']

    labels_mapping = json.load(open(r'..\data\Primary_Secondary_Outcomes\po_label_mapping.json', 'r'))
    ...
    output_dir = r"..\models\biobert_po_so"
